...
`vn-utils` is a collection of general-purpose utility traits and structures used across the VN-Suit workspace.
...
* **UpdateOption**: A trait extending `Option<T>` with convenient update methods.
