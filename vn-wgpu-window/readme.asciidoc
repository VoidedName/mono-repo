...
`vn-wgpu-window` is the rendering backend and windowing abstraction for the VN-Suit framework. It uses `wgpu` for hardware-accelerated rendering and `winit` for window management and event handling.
