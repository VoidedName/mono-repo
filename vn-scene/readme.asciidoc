...
`vn-scene` defines the core data structures and traits for representing a 2D scene. It acts as the bridge between the high-level UI/Logic and the low-level rendering backend.
